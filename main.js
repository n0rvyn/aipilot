...
var require_rng_browser = __commonJS((exports2, module2) => {
  var rng;
...
var require_uuid_browser = __commonJS((exports2, module2) => {
  var v1 = require_v1();
  var v4 = require_v4();
  var uuid = v4;
  uuid.v1 = v1;
...
var DEFAULT_SETTINGS = {
  ...
  promptCompareText: "Compare the following texts and show differences: "
};
var AIPilot = class extends import_obsidian.Plugin {
  constructor() {
    super(...arguments);
    this.requestId = null;
  }
...
var AIContentModal = class extends import_obsidian.Modal {
  constructor(app, content, onApply) {
    super(app);
  ...
  onOpen() {
    ...
    const discardBtn = contentEl.createEl("button", {text: "Discard"});
    applyBtn.onclick = () => {
    ...
    contentEl.appendChild(discardBtn);
  }
  onClose() {
    this.contentEl.empty();
  }
...
var ConfirmModal = class extends import_obsidian.Modal {
  ...
  onOpen() {
    ...
    const continueBtn = contentEl.createEl("button", {text: "Continue"});
...
var AITextSettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian.Setting(containerEl).setName("Provider").setDesc("Select the AI provider.").addDropdown((dropdown) => dropdown.addOption("openai", "OpenAI").addOption("zhipuai", "ZhipuAI").setValue(this.plugin.settings.provider).onChange(async (value) => {
    ...
    new import_obsidian.Setting(containerEl).setName("AI model").setDesc("Choose the AI model.").addDropdown((dropdown) => {
      ...
      Object.entries(models).forEach(([value, label]) => dropdown.addOption(value, label));
